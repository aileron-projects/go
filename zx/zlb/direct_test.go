...
var directTargets = map[string]struct {
	key     uint64
	found   bool
	name    string
	targets []*Target
...
func TestDirectHash_Get(t *testing.T) {
	t.Parallel()
	for name, tc := range directTargets {
...
var directWTargets = map[string]struct {
	key     uint64
	found   bool
	name    string
	targets []*Target
...
func TestDirectHashW_Get(t *testing.T) {
	t.Parallel()
	for name, tc := range directWTargets {
		t.Run(name, func(t *testing.T) {
