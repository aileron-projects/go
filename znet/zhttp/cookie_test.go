...
func TestGetMultiCookie(t *testing.T) {
	...
	t.Run("empty prefix for nil", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, 0, len(cks))
		ztesting.AssertEqual(t, "", value)
	})
	...
	t.Run("index from 0 to 0", func(t *testing.T) {
		...
		cks, value := zhttp.GetMultiCookie("prefix", cookies)
		ztesting.AssertEqual(t, 1, len(cks))
		ztesting.AssertEqual(t, "value0", value)
	})
	t.Run("index from 0 to 1", func(t *testing.T) {
		...
		cks, value := zhttp.GetMultiCookie("prefix", cookies)
		ztesting.AssertEqual(t, 2, len(cks))
		ztesting.AssertEqual(t, "value0value1", value)
	})
...
func TestSetMultiCookie(t *testing.T) {
	...
	t.Run("nil cookie", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, 0, len(cookie))
	})
	t.Run("empty value", func(t *testing.T) {
		rec := httptest.NewRecorder()
		cookie := zhttp.SetMultiCookie(rec, &http.Cookie{Name: "test", Value: ""})
		ztesting.AssertEqual(t, 1, len(cookie))
		ztesting.AssertEqual(t, http.Cookie{Name: "test0", Value: ""}, *cookie[0])
	})
	t.Run("non-empty value", func(t *testing.T) {
		rec := httptest.NewRecorder()
		cookie := zhttp.SetMultiCookie(rec, &http.Cookie{Name: "test", Value: "value"})
		ztesting.AssertEqual(t, 1, len(cookie))
		ztesting.AssertEqual(t, http.Cookie{Name: "test0", Value: "value"}, *cookie[0])
	})
	t.Run("copy attributes", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, 1, len(cookie))
		ztesting.AssertEqual(t, http.Cookie{Name: "test0", Value: "value", Domain: "example.com"}, *cookie[0])
	})
	t.Run("large value", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, 2, len(cookie))
		ztesting.AssertEqual(t, http.Cookie{Name: "test0", Value: strings.Repeat("0123456789", 200)}, *cookie[0])
		ztesting.AssertEqual(t, http.Cookie{Name: "test1", Value: strings.Repeat("0123456789", 200)}, *cookie[1])
	})
	t.Run("max length value", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, 2, len(cookie))
		ztesting.AssertEqual(t, http.Cookie{Name: "test0", Value: strings.Repeat("0123456789", 198) + "0123"}, *cookie[0])
		ztesting.AssertEqual(t, http.Cookie{Name: "test1", Value: "456789" + strings.Repeat("0123456789", 197) + "01234567"}, *cookie[1])
	})
}
