...
func TestReadFiles(t *testing.T) {
	...
	t.Run("no paths", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, 0, len(contents))
		ztesting.AssertEqual(t, nil, err)
	})
	...
	t.Run("not recursive", func(t *testing.T) {
		...
		for k, v := range want {
			...
			if !slices.Equal(v, vv) {
				ztesting.AssertEqual(t, v, contents[k])
			}
		}
		ztesting.AssertEqual(t, 2, len(contents))
		ztesting.AssertEqual(t, nil, err)
	})
...
func TestListFiles(t *testing.T) {
	...
	t.Run("contain empty", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, nil, paths)
		ztesting.AssertEqual(t, nil, err)
	})
	...
	t.Run("not recursive", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, want, paths)
		ztesting.AssertEqual(t, nil, err)
	})
	t.Run("recursive", func(t *testing.T) {
