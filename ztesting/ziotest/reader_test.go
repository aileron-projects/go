...
func TestCharsetReader(t *testing.T) {
	...
	t.Run("empty charset", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, io.EOF, err)
		ztesting.AssertEqual(t, "\x00\x00\x00", string(buf))
	})
	...
	t.Run("read chart without loop", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, "123", string(buf1))
		...
		ztesting.AssertEqual(t, io.EOF, err)
		ztesting.AssertEqual(t, "45\x00", string(buf2))
	})
	...
	t.Run("read chart with loop", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, 3, n)
		ztesting.AssertEqual(t, nil, err)
		ztesting.AssertEqual(t, "451", string(buf2))
	})
}
...
func TestErrReader(t *testing.T) {
	...
	t.Run("read exactly n", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, 3, n)
		ztesting.AssertEqual(t, io.ErrClosedPipe, err)
		ztesting.AssertEqual(t, "456", string(buf2))
	})
}
