...
func TestNewArgon2i(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		h, _ := b.Sum([]byte("test"))
		ztesting.AssertEqual(t, "31323334353637383930b73fc562d7f71262bb4099efad0d836c5e0496788c840c33cef2d90ef992e060", hex.EncodeToString(h))
	})
	t.Run("invalid param", func(t *testing.T) {
		b, err := zargon2.NewArgon2i(10, 0, 64*1024, 4, 32)
		ztesting.AssertEqual(t, nil, b)
		ztesting.AssertEqualErr(t, errors.New("zargon2: invalid hash parameter [argon2: number of rounds too small]"), err)
	})
}
...
func TestNewArgon2id(t *testing.T) {
	t.Run("success", func(t *testing.T) {
		...
		ztesting.AssertEqualErr(t, nil, err)
		h, _ := b.Sum([]byte("test"))
		ztesting.AssertEqual(t, "3132333435363738393046a3090e30874ea4dd680f04ee9bbb3ab0a01421de4fbe845649db192db746b3", hex.EncodeToString(h))
	})
	t.Run("invalid param", func(t *testing.T) {
...
func TestArgon2i_Split(t *testing.T) {
	t.Run("short hash", func(t *testing.T) {
		...
		ztesting.AssertEqualErr(t, zargon2.ErrShortHash, err)
	})
...
func TestArgon2i_Compare(t *testing.T) {
	...
	t.Run("pw not match", func(t *testing.T) {
		...
		ztesting.AssertEqualErr(t, zargon2.ErrNotMatch, err)
	})
