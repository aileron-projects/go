...
func TestSwap(t *testing.T) {
	...
	t.Run("not found", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, false, loaded)
		ztesting.AssertEqual(t, false, ok)
		ztesting.AssertEqual(t, "", prev)
		v, _ := store.Load("not found")
		ztesting.AssertEqual(t, "swapped", v)
	})
	t.Run("primitive assertion failed", func(t *testing.T) {
		store.Store("nil", nil)
		prev, loaded, ok := zsync.Swap[any, string](store, "nil", "swapped")
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, false, ok)
		ztesting.AssertEqual(t, "", prev)
		v, _ := store.Load("nil")
		ztesting.AssertEqual(t, "swapped", v)
	...
	t.Run("interface assertion failed", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, false, ok)
		ztesting.AssertEqual(t, nil, prev)
		v, _ := store.Load("nil")
		ztesting.AssertEqual(t, "swapped", v)
	})
	t.Run("swap string", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, "abc", prev)
	...
	t.Run("swap int", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, int(-123), prev)
		v, _ := store.Load("int")
		ztesting.AssertEqual(t, "swapped", v)
	})
	t.Run("swap int8", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, int8(-123), prev)
		v, _ := store.Load("int8")
		ztesting.AssertEqual(t, "swapped", v)
	})
	t.Run("swap int16", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, int16(-123), prev)
	...
	t.Run("swap int32", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, int32(-123), prev)
	...
	t.Run("swap int64", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, int64(-123), prev)
	...
	t.Run("swap uint", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, uint(123), prev)
		v, _ := store.Load("uint")
		ztesting.AssertEqual(t, "swapped", v)
	})
	t.Run("swap uint8", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, uint8(123), prev)
	...
	t.Run("swap uint16", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, uint16(123), prev)
	...
	t.Run("swap uint32", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, uint32(123), prev)
	...
	t.Run("swap uint64", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, uint64(123), prev)
	...
	t.Run("swap uintptr", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, uintptr(123), prev)
	...
	t.Run("swap float32", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, float32(123.45), prev)
	...
	t.Run("swap float64", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, float64(123.45), prev)
	...
	t.Run("swap complex64", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, complex64(1+2i), prev)
	...
	t.Run("swap complex128", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, complex128(1+2i), prev)
	...
	t.Run("swap error", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, io.EOF, prev)
		v, _ := store.Load("EOF")
		ztesting.AssertEqual(t, "swapped", v)
	})
	t.Run("swap struct", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, struct{}{}, prev)
...
func TestLoadOrStore(t *testing.T) {
	...
	t.Run("not found", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, false, loaded)
		ztesting.AssertEqual(t, false, ok)
		ztesting.AssertEqual(t, "", actual)
		v, _ := store.Load("not found")
		ztesting.AssertEqual(t, "stored", v)
	})
	t.Run("primitive assertion failed", func(t *testing.T) {
		store.Store("nil", nil)
	...
	t.Run("interface assertion failed", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, false, ok)
		ztesting.AssertEqual(t, nil, actual)
		v, _ := store.Load("nil")
		ztesting.AssertEqual(t, nil, v)
	})
	t.Run("string", func(t *testing.T) {
		...
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, "abc", actual)
		v, _ := store.Load("string")
		ztesting.AssertEqual(t, "abc", v)
	})
	t.Run("int", func(t *testing.T) {
		actual, loaded, ok := zsync.LoadOrStore[any, int](store, "int", "stored")
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, int(-123), actual)
		v, _ := store.Load("int")
		ztesting.AssertEqual(t, any(int(-123)), v)
	})
	t.Run("int8", func(t *testing.T) {
		actual, loaded, ok := zsync.LoadOrStore[any, int8](store, "int8", "stored")
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, int8(-123), actual)
		v, _ := store.Load("int8")
		ztesting.AssertEqual(t, any(int8(-123)), v)
	})
	t.Run("int16", func(t *testing.T) {
		actual, loaded, ok := zsync.LoadOrStore[any, int16](store, "int16", "stored")
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, int16(-123), actual)
		v, _ := store.Load("int16")
		ztesting.AssertEqual(t, any(int16(-123)), v)
	})
	t.Run("int32", func(t *testing.T) {
		actual, loaded, ok := zsync.LoadOrStore[any, int32](store, "int32", "stored")
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, int32(-123), actual)
		v, _ := store.Load("int32")
		ztesting.AssertEqual(t, any(int32(-123)), v)
	})
	t.Run("int64", func(t *testing.T) {
		actual, loaded, ok := zsync.LoadOrStore[any, int64](store, "int64", "stored")
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, int64(-123), actual)
		v, _ := store.Load("int64")
		ztesting.AssertEqual(t, any(int64(-123)), v)
	})
	t.Run("uint", func(t *testing.T) {
		actual, loaded, ok := zsync.LoadOrStore[any, uint](store, "uint", "stored")
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, uint(123), actual)
		v, _ := store.Load("uint")
		ztesting.AssertEqual(t, any(uint(123)), v)
	})
	t.Run("uint8", func(t *testing.T) {
		actual, loaded, ok := zsync.LoadOrStore[any, uint8](store, "uint8", "stored")
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, uint8(123), actual)
		v, _ := store.Load("uint8")
		ztesting.AssertEqual(t, any(uint8(123)), v)
	})
	t.Run("uint16", func(t *testing.T) {
		actual, loaded, ok := zsync.LoadOrStore[any, uint16](store, "uint16", "stored")
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, uint16(123), actual)
		v, _ := store.Load("uint16")
		ztesting.AssertEqual(t, any(uint16(123)), v)
	})
	t.Run("uint32", func(t *testing.T) {
		actual, loaded, ok := zsync.LoadOrStore[any, uint32](store, "uint32", "stored")
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, uint32(123), actual)
		v, _ := store.Load("uint32")
		ztesting.AssertEqual(t, any(uint32(123)), v)
	})
	t.Run("uint64", func(t *testing.T) {
		actual, loaded, ok := zsync.LoadOrStore[any, uint64](store, "uint64", "stored")
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, uint64(123), actual)
		v, _ := store.Load("uint64")
		ztesting.AssertEqual(t, any(uint64(123)), v)
	})
	t.Run("uintptr", func(t *testing.T) {
		actual, loaded, ok := zsync.LoadOrStore[any, uintptr](store, "uintptr", "stored")
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, uintptr(123), actual)
		v, _ := store.Load("uintptr")
		ztesting.AssertEqual(t, any(uintptr(123)), v)
	})
	t.Run("float32", func(t *testing.T) {
		actual, loaded, ok := zsync.LoadOrStore[any, float32](store, "float32", "stored")
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, float32(123.45), actual)
		v, _ := store.Load("float32")
		ztesting.AssertEqual(t, any(float32(123.45)), v)
	})
	t.Run("float64", func(t *testing.T) {
		actual, loaded, ok := zsync.LoadOrStore[any, float64](store, "float64", "stored")
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, float64(123.45), actual)
		v, _ := store.Load("float64")
		ztesting.AssertEqual(t, any(float64(123.45)), v)
	})
	t.Run("complex64", func(t *testing.T) {
		actual, loaded, ok := zsync.LoadOrStore[any, complex64](store, "complex64", "stored")
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, complex64(1+2i), actual)
		v, _ := store.Load("complex64")
		ztesting.AssertEqual(t, any(complex64(1+2i)), v)
	})
	t.Run("complex128", func(t *testing.T) {
		actual, loaded, ok := zsync.LoadOrStore[any, complex128](store, "complex128", "stored")
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, complex128(1+2i), actual)
		v, _ := store.Load("complex128")
		ztesting.AssertEqual(t, any(complex128(1+2i)), v)
	})
	t.Run("error", func(t *testing.T) {
		actual, loaded, ok := zsync.LoadOrStore[any, error](store, "EOF", "stored")
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, io.EOF, actual)
		v, _ := store.Load("EOF")
		ztesting.AssertEqual(t, any(io.EOF), v)
	})
	t.Run("struct", func(t *testing.T) {
		actual, loaded, ok := zsync.LoadOrStore[any, struct{}](store, "struct", "stored")
		ztesting.AssertEqual(t, true, loaded)
		ztesting.AssertEqual(t, true, ok)
		ztesting.AssertEqual(t, struct{}{}, actual)
		v, _ := store.Load("struct")
		ztesting.AssertEqual(t, any(struct{}{}), v)
	})
}
